                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-700">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <a href="{{ $settings->get('social_github', 'https://github.com') }}" target="_blank" class="w-12 h-12 bg-gray-100 dark:bg-gray-700 rounded-xl flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-indigo-500 hover:text-white transition-all duration-300">
                            ...
                            <a href="{{ $settings->get('social_linkedin', 'https://linkedin.com') }}" target="_blank" class="w-12 h-12 bg-gray-100 dark:bg-gray-700 rounded-xl flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-blue-600 hover:text-white transition-all duration-300">
                            ...
                            <a href="{{ $settings->get('social_twitter', 'https://twitter.com') }}" target="_blank" class="w-12 h-12 bg-gray-100 dark:bg-gray-700 rounded-xl flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-gray-900 hover:text-white transition-all duration-300">
                            ...
                            @endphp
                            <a href="https://wa.me/{{ $whatsapp }}" target="_blank" class="w-12 h-12 bg-gray-100 dark:bg-gray-700 rounded-xl flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-green-500 hover:text-white transition-all duration-300">
