        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <div class="flex space-x-4 rtl:space-x-reverse">
                    <a href="{{ $settings->get('social_github', 'https://github.com') }}" target="_blank" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:bg-indigo-600 hover:text-white transition">
                    ...
                    <a href="{{ $settings->get('social_linkedin', 'https://linkedin.com') }}" target="_blank" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:bg-indigo-600 hover:text-white transition">
                    ...
                    <a href="{{ $settings->get('social_twitter', 'https://twitter.com') }}" target="_blank" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:bg-indigo-600 hover:text-white transition">
                    ...
                    <a href="mailto:{{ $settings->get('contact_email', 'dev.abdo.shrief@gmail.com') }}" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:bg-indigo-600 hover:text-white transition">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="{{ route('home') }}" class="hover:text-indigo-400 transition flex items-center"><svg class="w-4 h-4 me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>{{ __('Home') }}</a></li>
                    <li><a href="{{ route('about') }}" class="hover:text-indigo-400 transition flex items-center"><svg class="w-4 h-4 me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>{{ __('About') }}</a></li>
                    <li><a href="{{ route('projects.index') }}" class="hover:text-indigo-400 transition flex items-center"><svg class="w-4 h-4 me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>{{ __('Projects') }}</a></li>
                    <li><a href="{{ route('services') }}" class="hover:text-indigo-400 transition flex items-center"><svg class="w-4 h-4 me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>{{ __('Services') }}</a></li>
                    <li><a href="{{ route('blog.index') }}" class="hover:text-indigo-400 transition flex items-center"><svg class="w-4 h-4 me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>{{ __('Blog') }}</a></li>
                </ul>
            </div>
